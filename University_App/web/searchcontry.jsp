...
<div class="container">
    ...
    <legend style=" margin-left:5px;background-color:#1f497d; padding-left:5px; padding-top:5px; padding-right:120px; padding-bottom:5px; ; color:white; border-radius:15px; border:8px solid #eeece1; font-size:20px;"><h2>Enter Your Marks</h2></legend>
	  	...
	  	<form action="resultcheck.jsp" method="post">
	  		<tr>
				<td><span class="style6">GRE</span></td>
                                <td><input type="text" name="gre"  style="width: 170px"/></td>
	  		</tr>
                        <tr>
				<td><span class="style6">IELETS</span></td>
				<td><input type="text" name="ielets" style="width: 170px"/></td>
	  		</tr>
                        <tr>
				<td><span class="style6">TOFEL</span></td>
				<td><input type="text" name="tofel" style="width: 170px"/></td>
	  		</tr>
	  		<tr>
				<td></td>
				<td>

...
<div class="container">
    ...
    <legend style=" margin-left:5px;background-color:#1f497d; padding-left:5px; padding-top:5px; padding-right:120px; padding-bottom:5px; ; color:white; border-radius:15px; border:8px solid #eeece1; font-size:20px;"><h2>Admin Login</h2></legend>

	  <table cellspacing="6" cellpadding="6" style="alignment-adjust: central;alignment-adjust: ">
	  	<form action="adminlogin.jsp" method="post">
	  		<tr>
				<td><span class="style6">Admin</span></td>

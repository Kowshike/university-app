                    ...
                    <nav class="nav put-right">
                        <ul class="sf-menu">
                          ...
                          <!--  <li>
                            ...
                            <li class="current"><a href="#">Academics</a>
                            <ul>
...
<div align="center" class="style4">
    ...
    <legend style=" margin-left:5px;background-color:#1f497d; padding-left:5px; padding-top:5px; padding-right:120px; padding-bottom:5px; ; color:white; border-radius:15px; border:8px solid #eeece1; font-size:20px;"><h2>Add Academics</h2></legend>

	  <table cellspacing="6" cellpadding="6" style="alignment-adjust: central; ">
	  	<form action="acadamiccheck.jsp" method="post">
...
%>
			...
			<tr>
				...
				<td><input type="text" name="cname" id="pass" required/></td>
                        ...
                        <tr>
				<td><span class="style6">Duration</span></td>
				<td><input type="text" name="duration" id="pass" required/></td>
	  		</tr>

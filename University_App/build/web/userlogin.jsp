            ...
            <div class="row">
                <div class="grid_12">
                    <div class="brand put-left">
                        <h1>
                            <a href="index.html">
                                <img src="images/logo_1.png" height="400" width="500" alt="Logo"/>
                            </a>
                        </h1>
                    </div>
                    <nav class="nav put-right">
                        <ul class="sf-menu">
                          ...
                          <!--  <li>
                            ...
                            <li class="current"><a href="userlogin.jsp">User</a></li>
...
<div class="camera-wrapper">
    <div id="camera" class="camera-wrap">
        <div data-src="images/adminlogin.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Admin Login!</h2>
                <a class="btn_1" href="#">More info</a>
            </div>
        </div>
        <div data-src="images/index_slide02.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Decision Your </h2>
                <a class="btn_1" href="#">More info</a>
            </div>
        </div>
        <div data-src="images/index_slide03.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Your Planning</h2>
                <a class="btn_1" href="#">More info</a>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <legend style=" margin-left:5px;background-color:#1f497d; padding-left:5px; padding-top:5px; padding-right:120px; padding-bottom:5px; ; color:white; border-radius:15px; border:8px solid #eeece1; font-size:20px;"><h2>User Login</h2></legend>

	  <table cellspacing="6" cellpadding="6" style="alignment-adjust: central;alignment-adjust: ">

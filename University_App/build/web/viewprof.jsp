    ...
    <table  border="50" width="1000" bgcolor="pink">
                    ...
                    <%
                        ...
                        while(rs.next())
                        {
                          ...
                          r=rs.getString("uname");
                          g=rs.getString("cname");
                          a=rs.getString("dname");
                           e=rs.getString("exp");
                           d=rs.getString("awards");
                         ad=rs.getString("pdesc");
                        ...
                        <tr align="center" >
                            ...
                            <td><%=d%></td>
                            <td><%=ad%></td>
                            <td><a href="deleteprof.jsp?<%=n%>"><button>DELETE</button></a></td>
